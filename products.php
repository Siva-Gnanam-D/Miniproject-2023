...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Yarners</h1>
                    <p>We have the best Yarns for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cord.jfif" alt="cord">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cord yarns</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/textured.jfif" alt="Textured">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Textured yarns</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/stretch.jfif" alt="stretch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Stretch yarns</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/metallic.jfif" alt="metallic">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Metallic yarns</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sewing.jfif" alt="sewing">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sewing thread</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cotton.jfif" alt="cotton">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cotton Yarn</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cot dyed.jfif" alt="cotton Dyed">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dyed Cotton </h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/gm.jfif" alt="GM">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Gassed Mercerised</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/hos.jfif" alt="Hosiery Yarn">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Hosiery Yarn </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Com.jfif" alt="Combed">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Combed Yarn </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Blend.jfif" alt="Blended">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Blended Yarn</h3>
           ...
           <footer class="footer">
               <div class="container">
               <center>
                <p>Copyright &copy Yarners. All Rights Reserved. | Contact Us: +91 96293 55890</p>
               </center>
               </div>
           </footer>
        </div>
